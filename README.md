...
With the simple [`hash32()`](/main.c#L125) no collisions were found (testing with and without the various `GL_` prefixes, a total of 2273 unique strings as of August 2026).
