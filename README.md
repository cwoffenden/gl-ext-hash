...
With the simple [`hash32()`](/main.c#L110) no collisions were found (testing with and without the various `GL_` prefixes, a total of 2429 strings as of August 2026).
