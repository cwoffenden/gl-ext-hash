...
With the simple [`hash32()`](//github.com/cwoffenden/gl-ext-hash/blob/main/main.c#L66) no collisions were found (testing with and without the various `GL_` prefixes, a total of 2428 strings as of August 2026).
